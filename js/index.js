...
$(".news_bar_list>li:nth-child(2)").click(function (e) {
  ...
  // 우선 모든 탭 배경색 초기화
  $(".news_bar_list>li:nth-child(2)").css(
    "background-color",
    "rgb(228, 228, 228)"
  );
  // 선택된 탭만 배경색 주기
...
$(".news_bar_list>li:nth-child(3)").click(function (e) {
  ...
  $(".news_con_1, .news_con_2, .news_con_3, .news_con_4, .news_con_5").hide();
  $(".news_bar_list>li").css("background-color", "white");
  $(".news_bar_list>li:nth-child(3)").css(
    "background-color",
    "rgb(228, 228, 228)"
  );
  $(".news_con_2").show();
...
$(".news_bar_list>li:nth-child(4)").click(function (e) {
  ...
  $(".news_con_1, .news_con_2, .news_con_3, .news_con_4, .news_con_5").hide();
  $(".news_bar_list>li").css("background-color", "white");
  $(".news_bar_list>li:nth-child(4)").css(
    "background-color",
    "rgb(228, 228, 228)"
  );
  $(".news_con_3").show();
...
$(".news_bar_list>li:nth-child(5)").click(function (e) {
  ...
  $(".news_con_1, .news_con_2, .news_con_3, .news_con_4, .news_con_5").hide();
  $(".news_bar_list>li").css("background-color", "white");
  $(".news_bar_list>li:nth-child(5)").css(
    "background-color",
    "rgb(228, 228, 228)"
  );
  $(".news_con_4").show();
...
$(".news_bar_list>li:nth-child(6)").click(function (e) {
  ...
  $(".news_con_1, .news_con_2, .news_con_3, .news_con_4, .news_con_5").hide();
  $(".news_bar_list>li").css("background-color", "white");
  $(".news_bar_list>li:nth-child(6)").css(
    "background-color",
    "rgb(228, 228, 228)"
  );
  $(".news_con_5").show();
...
$(".article_bar_list>li:nth-child(2)").click(function (e) {
  ...
  $(".article_bar_list>li:nth-child(2)").css(
    "background-color",
    "rgb(228, 228, 228)"
  );
  $(".article_con_1").show();
...
$(".article_bar_list>li:nth-child(3)").click(function (e) {
  ...
  $(".article_con_1, .article_con_2, .article_con_3").hide();
  $(".article_bar_list>li").css("background-color", "white");
  $(".article_bar_list>li:nth-child(3)").css(
    "background-color",
    "rgb(228, 228, 228)"
  );
  $(".article_con_2").show();
...
$(".article_bar_list>li:nth-child(4)").click(function (e) {
  ...
  $(".article_con_1, .article_con_2, .article_con_3").hide();
  $(".article_bar_list>li").css("background-color", "white");
  $(".article_bar_list>li:nth-child(4)").css(
    "background-color",
    "rgb(228, 228, 228)"
  );
  $(".article_con_3").show();
